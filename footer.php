            ...
            <div>
                ...
                <div class="space-y-3 mb-6">
                    ...
                    <div class="flex items-start space-x-3">
                        <span class="mt-0.5 inline-flex shrink-0 items-center rounded-full bg-blue-500/20 px-2 py-0.5 text-[11px] font-semibold uppercase tracking-wide text-blue-300">From Oct 1</span>
                        <span class="text-gray-400"><?php echo esc_html(get_practice_new_address()); ?></span>
                    </div>
                    <?php endif; ?>
                    <div class="flex items-center space-x-3">
