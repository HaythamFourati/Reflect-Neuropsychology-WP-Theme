  ...
  <body <?php body_class(); ?>>
    ...
    <header id="main-header" class="bg-white shadow-sm fixed top-0 left-0 right-0 z-50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center py-3 md:py-4">
          ...
          <nav class="hidden xl:flex items-center space-x-8">
            ...
            <div class="relative group">
              ...
              <div class="absolute top-full left-0 mt-2 w-[600px] bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                <div class="p-4">
                  <a href="<?php echo home_url('/neuropsychology-services/'); ?>" class="block px-4 py-3 text-sm text-gray-700 hover:bg-primary-50 hover:text-primary-600 rounded-lg mb-2 border-b border-gray-100">
                  ...
                  <div class="grid grid-cols-2 gap-2">
                    ...
                    <div class="space-y-1">
                      ...
                      <a href="<?php echo home_url('/pre-surgical-cognitive-assessment/'); ?>" class="block px-4 py-3 text-sm text-gray-700 hover:bg-primary-50 hover:text-primary-600 rounded-lg">
                        <div class="font-medium">Pre-Surgical Assessment</div>
                        <div class="text-xs text-gray-500">Baseline evaluations before surgery</div>
                      </a>
                      <a href="<?php echo home_url('/pediatric-adolescent-psychological-assessment/'); ?>" class="block px-4 py-3 text-sm text-gray-700 hover:bg-primary-50 hover:text-primary-600 rounded-lg">
                    ...
                    <div class="space-y-1">
                      ...
                      <a href="<?php echo home_url('/therapy-through-the-lifespan/'); ?>" class="block px-4 py-3 text-sm text-gray-700 hover:bg-primary-50 hover:text-primary-600 rounded-lg">
                        <div class="font-medium">Therapy Through Lifespan</div>
          ...
          <div class="flex items-center space-x-4">
            ...
            <!-- Mobile Menu Button -->
            <button id="mobile-menu-button" class="xl:hidden p-2 rounded-lg text-gray-700 hover:bg-gray-100">
        ...
        <div id="mobile-menu" class="xl:hidden hidden border-t border-gray-200 py-4">
          <div class="flex flex-col space-y-4 md:space-y-3">
            <a href="<?php echo home_url(); ?>" class="text-gray-700 hover:text-primary-600 transition-colors font-medium">Home</a>
