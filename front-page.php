    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-12 gap-12 items-center">
            <div class="lg:col-span-6 text-center lg:text-left">
                ...
                <h1 class="text-4xl md:text-6xl font-serif text-gray-900 mb-6">Unlocking minds.<br>Transforming Lives.</h1>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                    ...
                    <a href="<?php echo site_url('/neuropsychology-services/'); ?>" class="border-2 border-primary-600 text-primary-600 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-primary-50 transition-colors">Learn More About Our Services</a>
                </div>
            </div>
...
<section id="contact" class="py-20 bg-gradient-to-br from-primary-50 via-white to-gray-50 relative overflow-hidden">
                ...
                <div class="bg-white rounded-2xl shadow-xl p-8 border border-gray-100 flex-1 flex flex-col">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-center group">
                            <div class="flex-shrink-0 w-12 h-12 bg-primary-600 rounded-xl flex items-center justify-center mr-4 shadow-lg group-hover:shadow-xl transition-all duration-300">
                            ...
                            <div class="flex-1">
                                ...
                                <a href="tel:+18183243800" class="text-lg text-primary-600 font-semibold hover:text-primary-700 transition-colors">
                                    +1 818-324-3800
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="mt-auto pt-6 border-t border-gray-200">
                        <a href="tel:+18183243800" class="w-full bg-primary-600 text-white px-6 py-3 rounded-xl font-semibold hover:from-blue-700 hover:to-blue-800 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center justify-center">
