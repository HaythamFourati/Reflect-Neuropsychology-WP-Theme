...
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center mb-20">
            <!-- Left Column - Image -->
            <div class="relative">
                <div class="relative overflow-hidden rounded-2xl shadow-2xl h-[800px]">
                    <img src="https://www.reflectneuro.com/wp-content/uploads/2024/09/1527699833653.jpeg" 
                         alt="Dr. Judith L. Friedman, Licensed Clinical & Forensic Neuropsychologist" 
            ...
            <div class="relative lg:order-1">
                <div class="relative overflow-hidden rounded-2xl shadow-2xl">
                    <img src="https://www.reflectneuro.com/wp-content/uploads/2025/09/unnamed.jpg" 
                         alt="Dr. Shannel Elhelou, Clinical Neuropsychologist" 
                         class="w-full h-full object-cover">
                    <div class="absolute inset-0 bg-gradient-to-l from-green-600/20 to-transparent"></div>
                </div>
                <!-- Decorative elements -->
                <div class="absolute -bottom-6 -left-6 w-24 h-24 bg-green-100 rounded-full opacity-60 -z-10"></div>
                <div class="absolute -top-6 -right-6 w-16 h-16 bg-blue-50 rounded-full opacity-80 -z-10"></div>
            </div>
        </div>
        
        <!-- Dr. Genifer Goldsmith -->
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            <!-- Left Column - Image -->
            <div class="relative">
                <div class="relative overflow-hidden rounded-2xl shadow-2xl">
                    <img src="https://media.licdn.com/dms/image/v2/D4D03AQEuiHLqAbC5yw/profile-displayphoto-shrink_200_200/profile-displayphoto-shrink_200_200/0/1704781473489?e=2147483647&v=beta&t=9fLj0vFQh1hbqSwgvAGl5-ouBxcyY3pTEeKoanSShcc" 
                         alt="Dr. Genifer Goldsmith, Brain Health Specialist" 
