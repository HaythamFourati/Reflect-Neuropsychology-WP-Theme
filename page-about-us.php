...
$team_members = [
    ...
    [
        ...
        'bio' => [
            'Brianna Staley Shumaker, Ph.D., ABPP Board-Certified Clinical Psychologist
Dr. Brianna Staley Shumaker is a board-certified clinical psychologist specializing in comprehensive psychological and neuropsychological assessment across the lifespan. She evaluates adolescents, adults, and older adults to clarify diagnoses involving attention, executive functioning, learning, memory, emotional health, and complex cognitive concerns.
Her evaluations integrate standardized testing with medical, developmental, and functional history to provide clear, practical recommendations tailored to each individual. She has extensive experience assessing ADHD, traumatic brain injury, neurodevelopmental conditions, and neurodegenerative disorders.',
...
A former U.S. Army Captain and Behavioral Health Officer, Dr. Shumaker provided psychological assessment and consultation for military leadership and special operations personnel.',
            'She is board certified in clinical psychology through the American Board of Professional Psychology (ABPP) and is licensed in Washington, California, Virginia, and Indiana. Her work is grounded in evidence-based practice and focused on providing clarity, direction, and confidence for individuals and families.',
        ],
        'accent_color' => 'blue'
    ]
];
...
<!-- Our Team Section - Compact Card Design -->
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="space-y-8">
            <?php foreach ($team_members as $index => $member): ?>
                <div class="group bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100 overflow-hidden">
                    <div class="flex flex-col md:flex-row items-start gap-6 p-6 md:p-8">
                        ...
                        <div class="flex-shrink-0 mx-auto md:mx-0">
                            <div class="relative">
                                <img src="<?php echo $member['image']; ?>" 
                                     ...
                                     class="w-32 h-32 md:w-40 md:h-40 rounded-full object-cover object-top ring-4 ring-gray-100 group-hover:ring-primary-100 transition-all duration-300<?php echo ($index > 0) ? ' grayscale' : ''; ?>">
                                <div class="absolute -bottom-1 -right-1 w-8 h-8 bg-primary-500 rounded-full flex items-center justify-center shadow-lg">
                        ...
                        <div class="flex-1 text-center md:text-left">
                            <div class="flex items-center justify-center md:justify-start gap-2 mb-3">
                                ...
                                <span class="w-2 h-1 bg-primary-300 rounded-full"></span>
                            </div>
                            <h3 class="text-xl md:text-2xl font-serif text-gray-900 mb-1"><?php echo $member['name']; ?></h3>
                            <p class="text-primary-600 font-semibold mb-4"><?php echo $member['title']; ?></p>
